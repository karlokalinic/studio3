...
const Node = React.forwardRef<HTMLDivElement, { name: string; icon: React.ElementType; formula?: string; description?: string; colorClass?: string; children?: React.ReactNode }>(
    ...
    const nodeContent = (
         <div ref={ref} className="relative group flex items-center justify-center">
            <div 
                className={cn(`group w-24 h-24 bg-black/20 rounded-lg border-2 cursor-pointer shadow-md overflow-hidden relative flex flex-col items-center justify-center transition-all duration-300 hover:scale-105`, selectedColor.border)}
            >
                ...
                <p className={`absolute bottom-1.5 w-full text-center px-1 font-bold text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300`}>{name}</p>
            </div>
        </div>
    );
...
const Line = ({ type, gridArea, colorClass = 'bg-primary/20' }: { type: 'horizontal' | 'vertical' | 't-down' | 't-up' | 'cross' | 'corner-br' | 'corner-bl' | 'corner-tr' | 'corner-tl' | 'radial-tr' | 'radial-tl' | 'radial-br' | 'radial-bl' | 'z-ne' | 'z-en' | 'z-sw' | 'z-ws'; gridArea: string, colorClass?: string }) => {
  ...
  return (
    <div style={{ gridArea }} className="relative w-full h-full">
      ...
      {type === 'cross' && <div className={`${baseClasses} absolute top-1/2 left-0 w-full h-0.5 -translate-y-1/2`}></div> }
      
      { type.startsWith('corner-b') && !type.startsWith('corner-bl') && <div className={`${baseClasses} absolute top-1/2 left-0 w-full h-0.5 -translate-y-1/2`}></div> }
      { type.startsWith('corner-t') && !type.startsWith('corner-tr') && <div className={`${baseClasses} absolute top-1/2 left-0 w-full h-0.5 -translate-y-1/2`}></div> }
    ...
    <Card className="bg-card/50 border-primary/20 shadow-lg shadow-primary/5">
      ...
      <CardContent className="p-0 overflow-x-hidden">
          <div className="grid" style={gridStyles}>
            ...
            <Line type="horizontal" gridArea="2/3/3/5" />
            <Line type="horizontal" gridArea="2/5/3/7" />
            ...
            <Line type="t-down" gridArea="2/3/4/4" />
            <Line type="horizontal" gridArea="3/3/4/4" colorClass="bg-destructive/20"/>
            <Line type="corner-br" gridArea="3/2/4/3" />
            <Line type="t-down" gridArea="2/5/4/6" />
            <Line type="horizontal" gridArea="3/5/4/6" colorClass="bg-destructive/20"/>
            <Line type="corner-br" gridArea="3/4/4/5" />
            <Line type="t-down" gridArea="2/7/4/8" />
            <Line type="horizontal" gridArea="3/7/4/8" colorClass="bg-destructive/20"/>
            ...
            <Line type="radial-bl" gridArea="6/5/7/4" colorClass="bg-yellow-400/20" />
            <Line type="radial-br" gridArea="6/7/7/4" colorClass="bg-yellow-400/20" />
            ...
            {/* Row 10: Connections from Convergence */}
             ...
             <Line type="cross" gridArea="10/5/11/6" colorClass="bg-orange-500/20" />
            ...
            <Line type="corner-tl" gridArea="10/3/11/2" /><Line type="horizontal" gridArea="11/1/12/2" colorClass="bg-cyan-400/20"/>
            <Line type="corner-tr" gridArea="10/3/11/4" /><Line type="horizontal" gridArea="11/3/12/4" colorClass="bg-fuchsia-500/20"/>
            <Line type="t-up" gridArea="10/5/12/6" /><Line type="horizontal" gridArea="11/5/12/6" colorClass="bg-lime-500/20"/>
            <Line type="corner-tl" gridArea="10/7/11/8" /><Line type="horizontal" gridArea="11/7/12/8" colorClass="bg-slate-500/20" />
            <Line type="corner-tr" gridArea="10/7/11/8" /><Line type="horizontal" gridArea="11/8/12/9" colorClass="bg-destructive/20" />
            ...
            <Line type="corner-tr" gridArea="14/2/15/3" colorClass="bg-cyan-400/20" />
            <Line type="corner-tl" gridArea="14/4/15/3" colorClass="bg-cyan-400/20" />

            <Line type="corner-tr" gridArea="14/4/15/5" colorClass="bg-fuchsia-500/20" />
            <Line type="corner-tl" gridArea="14/6/15/5" colorClass="bg-fuchsia-500/20" />

            <Line type="corner-tr" gridArea="14/6/15/7" colorClass="bg-lime-500/20" />
             <Line type="horizontal" gridArea="14/2/15/4" />
             <Line type="horizontal" gridArea="14/4/15/6" />
          </div>
      </CardContent>
    </Card>
  );
